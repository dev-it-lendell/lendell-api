...
class Department extends Model {
  ...
  static async insert(data, transaction) {
    try {
      ...
      const query = `INSERT INTO departments (${fields}) VALUES (${values})`;
      ...
      const selectQuery = `SELECT * FROM departments WHERE id = :id`;
  ...
  static async update(
    ...
    try {
      ...
      const query = `UPDATE departments SET ${setClause} WHERE ${whereClause}`;
      ...
      const selectQuery = `SELECT * FROM departments WHERE ${whereClause}`;
